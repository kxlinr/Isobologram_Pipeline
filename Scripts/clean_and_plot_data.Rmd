...
plot_isobologram = function(data, #data to interpolate and plot
                            ...
                            xlimit=max(nutlin_doses),#Specify how far along the x axis to plot
                            ylimit=max(rad_doses)){ #Specify how far along the y axis to plot
...
for(i in 1:length(data)){
  plot_isobologram(data=data[[i]], plot_title=plot_titles[i])
}

# OR #
## Plot each experiment, with specific x- and y-axis limits for each
# plot_isobologram(data=data[[1]], plot_title=sheet_name[1], xlimit=10) #NTC+MCherry
# plot_isobologram(data=data[[2]], plot_title=sheet_name[2], xlimit=25) #NTC+R273C
# plot_isobologram(data=data[[3]], plot_title=sheet_name[3], xlimit=100) #NTC+KO

plot_isobologram(data=data[[1]], plot_title=plot_titles[1], xlimit=0.75, ylimit=4) #JHUEM2

# plot_isobologram(data=data[[1]], plot_title=plot_titles[1], xlimit=5, ylimit= 4) #JHUEM2
# plot_isobologram(data=data[[2]], plot_title=plot_titles[2], xlimit=45) #Hec108
# plot_isobologram(data=data[[3]], plot_title=plot_titles[3], xlimit=100) #Hec18b
